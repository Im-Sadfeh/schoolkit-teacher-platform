...
echo "Removing worktree: ../task-11-worktree..."
git worktree remove ../task-11-worktree --force 2>/dev/null || echo "  Worktree not found or already removed"
echo "Removing worktree: ../task-12-worktree..."
git worktree remove ../task-12-worktree --force 2>/dev/null || echo "  Worktree not found or already removed"
